...
DEFAULT_PAGES: list = [
    ('Get help', LandingPage, [
        ('How Shout works', LandingPage),
        ('Issues', LandingPage),
        ('Resources', LandingPage),
    ]),
    ('Get involved', LandingPage, [
        ('Volunteer for Shout', LandingPage),
        ('Donate to Shout', LandingPage),
        ('Share the number', LandingPage),
        ('Share your story', LandingPage),
        ('Partner with us', LandingPage),
    ]),
    ...
    ('About us', LandingPage,
        [
            ...
            ('Our supporters', LandingPage),
            ('Work with us', LandingPage),
        ]),
    ('Search', SearchPage, []),
    ('Privacy centre', UtilityPage, []),
...
DEFAULT_TAXONOMY: list = [
    ('Blog posts', NewsCategory),
    ('Case studies', NewsCategory),
    ('News', NewsCategory),
    ('Campaigns', NewsCategory),
]

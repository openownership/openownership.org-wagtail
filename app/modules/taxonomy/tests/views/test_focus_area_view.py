...
def test_queryset_tagged_pages(blog_index_page):
    ...
    dogs_tag = FocusAreaTag.objects.create(name='Dogs')
...
def test_queryset_live_pages(blog_index_page):
    ...
    FocusAreaTaggedPage.objects.create(tag=tag, content_object=live_post)
...
def test_queryset_all_kinds_of_page(blog_index_page):
    ...
    FocusAreaTaggedPage.objects.create(tag=tag, content_object=blog_post)
    ...
    FocusAreaTaggedPage.objects.create(tag=tag, content_object=job)
...
def test_queryset_order(blog_index_page):
    ...
    FocusAreaTaggedPage.objects.create(tag=tag, content_object=post_1)

    post_2 = BlogArticlePage(live=True, title="Post 2")
    blog_index_page.add_child(instance=post_2)
    post_2.save_revision().publish()
    FocusAreaTaggedPage.objects.create(tag=tag, content_object=post_2)
...
def test_queryset_section(blog_index_page):
    ...
    FocusAreaTaggedPage.objects.create(tag=tag, content_object=post)
